// prg4 - Stack with Structure
// Write a C program to implement Stack with Structure data structure with push, pop, peek, and display operations.
...
>> New element 23 succefully entered in the STACK <<
The STACK is :
...
>> New element 34 succefully entered in the STACK <<
The STACK is :
...
>> New element 45 succefully entered in the STACK <<
The STACK is :
...
>> Top element 45 succefully deleted from the STACK <<
The STACK is :
...
>> Top element 34 succefully deleted from the STACK <<
The STACK is :
...
>> Top element 23 succefully deleted from the STACK <<
The STACK is :
...
>> Top element 12 succefully deleted from the STACK <<
The STACK is :
